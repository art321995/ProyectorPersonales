export const NAV_LINKS = [
  ...
  export const HERO = {
    title: "Descubre aquí tu hogar ideal!",
    description:
      "Descubra la casa de sus sueños con nuestros servicios inmobiliarios. Ya sea que esté buscando comprar, vender o rentar, estamos aquí para ayudarlo.",
  };
  
  export const HOW_IT_WORKS = {
    title: "Como Trabajamos",
    content:
      "Encontrar la propiedad de sus sueños es fácil con nuestro proceso paso a paso. Primero, explore nuestros extensos listados de propiedades, incluidos apartamentos, casas y espacios comerciales. Una vez que encuentre una propiedad que le interese, programe una visita con uno de nuestros agentes experimentados. Durante la visita, nuestro agente le proporcionará toda la información necesaria sobre la propiedad y responderá cualquier pregunta que pueda tener. Si decide seguir adelante, nuestro equipo lo guiará a través del proceso de alquiler o compra, garantizando una experiencia fluida y sin complicaciones. Con nuestra experiencia y dedicación a la satisfacción del cliente, encontrar su propiedad ideal nunca ha sido tan fácil.",
    steps: [
      {
        title: "Paso 1",
        text: "Explore nuestros extensos listados de propiedades, incluidos apartamentos, casas y espacios comerciales.",
      },
      {
        title: "Paso 2",
        text: "Programe una visita con uno de nuestros agentes experimentados. Durante la visita, nuestro agente le proporcionará toda la información necesaria sobre la propiedad y responderá cualquier pregunta que pueda tener.",
      },
      {
        title: "Paso 3",
        text: "Si decide seguir adelante, nuestro equipo lo guiará a través del proceso de alquiler o compra.",
      },
    ],
  };
  ...
  export const FEATURED_PROPERTIES = [
    ...
    {
      name: "Departamento Espacioso en la Ciudad",
      price: "280,000",
      rating: 4.7,
      reviews: 55,
      image: "/image-3.jpg",
    ...
    {
      name: "Retiro con vistas a la montaña",
      price: "950,000",
      rating: 4.9,
      reviews: 78,
      image: "/image-4.jpg",
    ...
    {
      name: "Villa de Lujo frente al Mar",
      price: "290,000",
      rating: 4.6,
      reviews: 57,
      image: "/image-9.jpg",
