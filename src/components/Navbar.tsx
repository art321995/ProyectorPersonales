    ...
    <nav className="fixed top-2 z-50 w-screen px-4">
      <div className="container flex items-center justify-between rounded-lg bg-black py-3">
        <div className="flex flex-shrink-0 items-center justify-between">
          ...
          <span className="text-sm tracking-tight text-white">CasasMX</span>
        </div>
        ...
        <div className="hidden text-sm text-white lg:flex">
            <Button variant="outline" className="mr-2 bg-black"> Ingresar </Button> 
            <Button className="bg-slate-800"> Registrate </Button>
        </div>
