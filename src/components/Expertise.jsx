...
const Expertise = () => {
  return (
    <section id="expertise">
        <h2 className="my-8 text-center text-3xl tracking-tighter lg:text-4xl">Nuestra Expertis</h2>
               ...
               <div key={index} className="flex items-center border-b-4 border-dotted border-neutral-700/40 py-2">
                ...
                <div className="pl-8">
                    <motion.h3
                      ...
                      className="text-2xl uppercase tracking-tighter text-rose-300">{cusine.title}
                    </motion.h3>
                    <motion.p 
                      initial={{opacity: 0, y: 50}}
                      whileInView={{opacity: 1, y: 0}}
                      ...
                      className="mt-4 text-lg tracking-tighter">{cusine.description}
                    </motion.p>
                </div>
               </div> 
            ))}
