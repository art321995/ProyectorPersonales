...
const HowItWorks = () => {
  return (
    <div className="container mx-auto my-10  pd-10" id="Trabajo">
        ...
        <div className="works relative h-[640px] rounded-xl">
            <div className="absolute left-0 top-0 h-full overflow-hidden p-10 md:p-20">
                {HOW_IT_WORKS.steps.map((step, index) => (
                    ...
                    <p className="my-2 max-w-80 text-neutral-200">{step.text}</p>
                    </div> 
                ))}
            </div> 
        </div>
