    ...
    <motion.section
      ...
      <div className="flex flex-wrap">
        <div className="w-full px-2 lg:w-1/2">
          <h4 className="text-2xl tracking-tighter lg:text-4xl">¡ Bienvenidos a Dulcería Imperial !</h4>
          <p className="m-4 text-md leading-relaxed tracking-tight lg:max-w-xl">
            En Dulcería Imperial, nos apasiona endulzar tus momentos especiales con los sabores más irresistibles. 
            Desde nuestra fundación en el año 2020, hemos estado comprometidos en ofrecer una amplia variedad de dulces, chocolates,  
            productos de reposteria, regalos y botanas de la mejor calidad.
          </p>
          <p className="m-4 text-md leading-relaxed tracking-tight lg:max-w-xl">
          ...
          <p className="m-4 text-md leading-relaxed tracking-tight lg:max-w-xl">
            ...
            especial. Por eso, nuestro equipo trabaja con dedicación para ofrecerte un excelente servicio, asegurándonos de 
            que encuentres justo lo que necesitas.
          </p>
          <p className="m-4 text-md leading-relaxed tracking-tight lg:max-w-xl">
            Ya sea para una fiesta, un regalo, o simplemente para darte un capricho, en Dulcería Imperial estamos aquí para endulzar tu vida, 
