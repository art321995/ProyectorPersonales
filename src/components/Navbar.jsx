  ...
  return (
    <div>
      <nav className="fixed top-4 z-50 flex w-full flex-col items-center justify-center">
        ...
        {isMobileMenuOpen && (
          <div className="w-full backdrop-blur-lg lg:hidden">
            <a href="#" className="block p-3 tracking-tighter cursor-pointer" onClick={toggleMobileMenu}>Inicio</a>
      ...
      <motion.div 
        ...
        <img src="./img/Portada.png" alt="Portada" className="w-full rounded-3xl p-4" />
      </motion.div>
    </div>
  );
};
